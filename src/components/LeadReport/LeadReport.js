...
export const LeadReport=()=>{
    return(
        <div>
            ...
            <h1 > <b>  Leads Dashboard  </b> </h1>
            </div>

                    <PowerBIEmbed
                      embedConfig = {{
                        type: 'dashboard',   // Supported types: report, dashboard, tile, visual and qna
                        id: 'a939fff0-03f1-4a16-9b48-7b72875144a5',
                        embedUrl: 'https://app.powerbi.com/view?r=eyJrIjoiMGY2YzNmOGYtMGYwYi00MGI1LWJlMGUtZTM0YWFhZDM3Yzk1IiwidCI6ImY4OGQ0ZTM1LTA0ZDEtNDQ0OS1hYmNlLWQxN2YwMWJlOWNiNSJ9',
