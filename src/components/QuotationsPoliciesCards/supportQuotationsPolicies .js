...
import moment from 'moment'
 ...
 export default {
     ...
     arrangeData(resObj){
        ...
        //  NNEEWW start
        console.log(resObj.appointmentDate, 'resObj.appointmentDate');
        if (resObj.appointmentDate === null){
            dataStructure.appointDate = "-"
        }else{
            dataStructure.appointDate = moment(parseInt(resObj.appointmentDate)).format('DD/MM/YYYY')
        }
        //  NNEEWW end
