...
const MotorConfirmPage = () => {
  ...
  if (channelCode?.channelCode === "CH1") {
    ...
    createFormData.agentCode = getAgentCode.toString()
  }
  ...
  //   let result = await axiosRequest.post("user/motor-policy", createFormData, {
  //     secure: true,
  //   });
  ...
  //       if (
  //         result?.data?.oonaQuotationResponse?.technicalControls?.[0]
  //           ?.code === 1624 ||
  //         result?.data?.oonaQuotationResponse?.technicalControls?.[0]
  ...
  //       } else {
  //         history.push("/formal-technical-control");
  //       }
  //       // history.push("/motor-technical-control");
  //     } else if (
  //       result?.data?.oonaPolicyResponse?.paymentBreakdown == null ||
  //       result?.data?.oonaPolicyResponse?.technicalControls.length > 0
  //     ) {
