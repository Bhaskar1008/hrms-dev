...
export default function CustomerDetail() {
  ...
  const onClickBackbtn = () => {
    history.push("/travel-policy-holder");
  };
  ...
  const onClickConfirm = async () => {
    ...
    const formData = {
      travel_information: {
        ...
        // agentCode: 0,
        branchCode: tripData?.travelPolicyData?.commercial?.value ? tripData?.travelPolicyData?.commercial?.value : tripData?.travelPolicyData?.commercial, // ===================>          SEND====> 0 / null   Don't send other value it is OPTIONAL Field
        branchCodeName: tripData?.travelPolicyData?.commercial?.label ? tripData?.travelPolicyData?.commercial?.label : tripData?.travelPolicyData?.commercial, // ===================>          SEND====> 0 / null   Don't send other value it is OPTIONAL Field
        branchCodeName: tripData?.travelPolicyData?.commercial?.label ? tripData?.travelPolicyData?.commercial?.label : tripData?.travelPolicyData?.commercial,
