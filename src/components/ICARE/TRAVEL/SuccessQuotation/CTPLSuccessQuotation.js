...
export default function CTPLSuccessQuotation() {
  ...
  const AgentCodeFromSelect = useSelector((state) => state?.ctplqoutation?.formData?.quotation_group_info?.agentCode);
  ...
  let createFormData = { 
    ...
    documentUploaded: hyperStatus == "auto_approved" ? true : false,
  };
