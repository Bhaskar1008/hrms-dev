...
export default function PaymentFailedMotorCypher(props) {
  ...
  const MayaPolicyNumberCancle = props?.location?.state?.data?.oonaPolicyResponse?.policyNumber;
  const MayaRefreranceNumberCancle = props?.location?.state?.data?.oonaPolicyResponse?.referenceNumber;
  console.log("MayaPolicyNumberCancle", MayaPolicyNumberCancle, MayaRefreranceNumberCancle);
  ...
  const policyPaymentFail = {
    ...
    section2: {
      // ${policyNumber}
      title: `Policy #${MayaPolicyNumber ? MayaPolicyNumber : MayaPolicyNumberCancle}`,
      subTitle: `Payment Reference #${MayaRefreranceNumber ? MayaRefreranceNumber : MayaRefreranceNumberCancle}`,
      // ${policyReferance}
      data: data,
      displayDetails: false,
      successBtn: {
