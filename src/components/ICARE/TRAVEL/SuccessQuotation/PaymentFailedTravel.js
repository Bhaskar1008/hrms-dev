...
export default function PaymentFailedTravel(props) {
  ...
  const refreshNumberNumberFrommayaCancle = props?.location?.state?.data?.oonaPolicyResponse?.referenceNumber;
  const PolicyNumberFrommayaCancle = props?.location?.state?.data?.oonaPolicyResponse?.policyNumber;
  const PolicyFrommayaCancle_Id = props?.location?.state?.data?._id;
  console.log("PolicyNumberFrommayaCancle=====>>>", refreshNumberNumberFrommayaCancle, PolicyFrommayaCancle_Id)
  ...
  const policyPaymentFail = {
    ...
    section2: {
      ...
      subTitle: `Payment Reference #${refreshNumberNumberFrommaya ? refreshNumberNumberFrommaya : refreshNumberNumberFrommayaCancle }`,
      // ${policyReferance}
      data: data,
      displayDetails: false,
      successBtn: {
  ...
  return (
    ...
    <div className="main-container">
      ...
      <QuoteSuccessPage {...policyPaymentFail} onClick={() => paymentFailed(PolicyId ? PolicyId : PolicyFrommayaCancle_Id)} />
