...
import PolicyQuoteFooter from "../components/motor_sharable_comp/MotorFormFooter/MotorFormFooter";
...
import HypervergeComponent from "./Hyperverge";
...
export default function PolicyHolder() {
    ...
    const finalSubmit = (formData) => {
        ...
        if (showCondition) {
            history.push("/customer-alternate-policyholder");
        } else {
