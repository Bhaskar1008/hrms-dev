...
export default function SuccessQuotePage({ section1, section2, onClick ,onClickedit}) {
  return (
    <>
          ...
          <div style={{ height: "fit-content" }}>
            ...
            {section2.title ? (
              <p style={{ marginBottom: section2.subTitle ? "10px" : "" }}>
                {section2.title}{" "}
                {section2.tag ? <span>{section2.tag}</span> : ""}
              </p>
            ) : (
              ""
            )}
            ...
            {section2.downloadEditBtn.show ? (
              <div className="setOfbtn">
                <Button className="quoteWhiteBtn">Download Quote (PDF)</Button>
                <Button className="quoteWhiteBtn"  onClick={() => onClick && onClickedit()}>Edit</Button>
              </div>
            ) : (
              ""
            )}
            {section2.backBtn.show ? (
              <Button className="quoteBtnLight">
                {" "}
