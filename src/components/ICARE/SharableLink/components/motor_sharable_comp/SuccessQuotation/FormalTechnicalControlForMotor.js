...
import Quotationpendingpage from "../../../components/ShareableLinkTravel/commonComponent/Quotationpendingpage";
import { useDispatch, useSelector } from "react-redux";
import WithoutApproxFooter from "../MotorFormFooter/QuickQuoteFooter/WithoutApproxFooter";
import PolicyApproxFooter from "../MotorFormFooter/QuickQuoteFooter/WithoutApproxFooter";
...
export default function TechnicalControlForMotor() {
  ...
  let formalQuotationNumber =
    confirmTest?.motorQuotation?.motorPolicyResponse?.data
  ...
  return (
    <>
      ...
      <div className="main-container">
        <Quotationpendingpage {...policyFail} />
      </div>
      <PolicyApproxFooter />
    </>
  );
