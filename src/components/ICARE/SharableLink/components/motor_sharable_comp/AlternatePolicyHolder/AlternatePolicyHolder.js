...
export default function AlternatePolicyHolder() {
  ...
  const onchangetoNext = () => {
    history.push("/customer-motor-confirm-page");
  };

  const checkVerified = (details, section) => {
    if (isAlternatePolicyValidated == "no" &&
      isAlternatePolicyBtnTriggered && section == "alternate-policy") {
      resetInput(
        "alternate-policy",
        "clear",
        alternatePolicySec
    ...
    if (isOwnerValidated == "no" && isOwnerBtnTriggered && section == "owner") {

      resetInput("owner", "clear", ownerDetails)
      return

    }
    if (isDriverValidated == "no" && isDriverBtnTriggered && section == "driver") {
      resetInput("driver", "clear", driverDetails)

      return
    }
    if (isLessorValidated == "no" && isLessorBtnTriggered && section == "lessor") {
      resetInput("lessor", "clear", lessorDetails)
      return
    }
    if (isLesseeValidated == "no" && isLesseeBtnTriggered && section == "lessee") {
      resetInput("lessee", "clear", lesseeDetails)
      return
    }
    if (isAssigneeValidated == "no" && isAssigneeBtnTriggered && section == "assignee") {
              ...
              <>
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${alternatePolicy == "yes" ? "check-btn-click" : ""
                        }`}
                      onClick={() => {
                        resetInput(
                          "alternate-policy",
                    ...
                    <Button
                      className={`check-btn ${alternatePolicy == "no" ? "check-btn-click" : ""
                        }`}
                      onClick={() => {
                        resetInput(
                          "alternate-policy",
                  ...
                  {alternatePolicy == "yes" && (
                    <div className="verified-container">
                      <Button
                        className={`verified ${isAlternatePolicyValidated == "yes"
            ...
            {showSectionByCondition.owner === "0" ? (
              <>
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${owner == "yes" ? "check-btn-click" : ""
                        }`}
                    ...
                    <Button
                      className={`check-btn ${owner == "no" ? "check-btn-click" : ""
                        }`}
                  ...
                  {owner == "yes" && (
                    <div className="verified-container">
                      <Button
                        className={`verified ${isOwnerValidated == "yes"
                          ? "valid-user event-none"
                          : ""
            ...
            {showSectionByCondition.driver === "0" ? (
              <>
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${driver == "yes" ? "check-btn-click" : ""
                        }`}
                    ...
                    <Button
                      className={`check-btn ${driver == "no" ? "check-btn-click" : ""
                        }`}
                  ...
                  {driver == "yes" && (
                    <div className="verified-container">
                      ...
                      <Button
                        className={`verified ${isDriverValidated == "yes"
                          ? "valid-user event-none"
                          : ""
            ...
            {showSectionByCondition.leased == "1" ? (
              <>
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${Lessor == "yes" ? "check-btn-click" : ""
                        }`}
                    ...
                    <Button
                      className={`check-btn ${Lessor == "no" ? "check-btn-click" : ""
                        }`}
                  ...
                  {Lessor == "yes" && (
                    <div className="verified-container">
                      <Button
                        className={`verified ${isLessorValidated == "yes"
                          ? "valid-user event-none"
                          : ""
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${Lessee == "yes" ? "check-btn-click" : ""
                        }`}
                    ...
                    <Button
                      className={`check-btn ${Lessee == "no" ? "check-btn-click" : ""
                        }`}
                  ...
                  {Lessee == "yes" && (
                    <div className="verified-container">
                      <Button
                        className={`verified ${isLesseeValidated == "yes"
                          ? "valid-user event-none"
                          : ""
            ...
            {showSectionByCondition.assigned === "1" ? (
              <>
                ...
                <div className="existing-customer-container">
                  ...
                  <div className="buttons-container">
                    <Button
                      className={`check-btn ${Assignee == "yes" ? "check-btn-click" : ""
                        }`}
                      onClick={() =>
                    ...
                    <Button
                      className={`check-btn ${Assignee == "no" ? "check-btn-click" : ""
                        }`}
                      onClick={() =>
                  ...
                  {Assignee == "yes" && (
                    <div className="verified-container">
                      ...
                      <Button
                        className={`verified ${isAssigneeValidated == "yes"
                          ? "valid-user event-none"
                          : ""
