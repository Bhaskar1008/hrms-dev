...
;
  ...
  const Paymnetgatewayredirect   = async (event)=>{
    ...
    // let formdata = {
    //   requestId: MotorPolicyGetDataCypher?.travelPolicyQuotationData?.oonaPolicyResponse?.referenceNumber, // policy refrence number
    //   ipAddress: "192.168.1.1",
    //   cancelUrl: Apiconfig?.ProjectLink + "/Fail",
    //   firstName: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.firstName,
    //   middleName: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.middleName,
    //   lastName: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.lastName,
    //   address1: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.address1,
    //   address2: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.address2,
    //   city: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.city,
    //   state: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.province,
    //   zip: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.zipCode,
    //   email: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.emailAddress,
    //   phone: MotorPolicyGetDataCypher?.travel_information?.policyHolder?.mobileNumber,
    //   mobile: "",
    //   amount: MotorPolicyGetDataCypher?.travelPolicyQuotationData?.oonaPolicyResponse?.paymentBreakdown?.grossPrem,
    ...
    //   policyNo: MotorPolicyGetDataCypher?.travelPolicyQuotationData?._id, // policy _id
    // };
  //   if(MotorPolicyGetDataCypher?.travelUserDetailedInfo === null){

  //     let TravelDatafromlisting = MotorPolicyGetDataCypher?.travelPolicyQuotationData?.travel_information?.policyHolder
  //   formdata = {
  //     requestId: MotorPolicyGetDataCypher?.travelPolicyQuotationData?.oonaPolicyResponse?.referenceNumber, // policy refrence number
  //     ipAddress: "192.168.1.1",
  //     cancelUrl: Apiconfig?.ProjectLink + "/Fail",
  ...
  // }
    // console.log(
    //   "MotorPolicyGetDataCypher?.travelPolicyQuotationData?._id",
    //   MotorPolicyGetDataCypher?.travelPolicyQuotationData?._id
    // );
    // return
    ...
    const axios = require('axios');
    let formdata = {
      // requestId: MotorPolicyGetDataCypher?.oonaPolicyResponse?.referenceNumber, // policy refrence number
      // ipAddress: "192.168.1.1",
      // cancelUrl: Apiconfig?.ProjectLink + "/motor-payment-return-url-cyphyer/" + finalCypher,
      ...
      // paymentMethod: event.paymentMethod,
      // responseUrl: Apiconfig?.ProjectLink + "/motor-payment-return-url-cyphyer/" + finalCypher , //return url
      // policyNo: MotorPolicyGetDataCypher?._id, // policy _id
