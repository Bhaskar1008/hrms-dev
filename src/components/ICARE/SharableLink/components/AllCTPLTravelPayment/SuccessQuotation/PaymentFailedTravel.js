...
export default function PaymentFailedTravel(props) {
  ...
  console.log("refreshNumberNumberFrommaya=====>>>", refreshNumberNumberFrommaya, PolicyNumberFrommaya)
  ...
  const policyPaymentFail = {
    ...
    section2: {
      // ${policyNumber}
      title: `Policy #${PolicyNumberFrommaya}`,
      subTitle: `Payment Reference #${refreshNumberNumberFrommaya}`,
      // ${policyReferance}
      data: data,
      displayDetails: false,
      successBtn: {
  ...
  return (
    ...
    <div className="main-container">
      ...
      <QuoteSuccessPage {...policyPaymentFail} onClick={() => paymentFailed(PolicyId)} />
