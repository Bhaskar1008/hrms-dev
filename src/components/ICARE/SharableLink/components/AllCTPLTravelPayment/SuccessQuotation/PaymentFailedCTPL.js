...
export default function PaymentFailedCTPL(props) {
  ...
  let PolicyNumberMayaForm = props?.location?.state?.data?.oonaPolicyResponse?.policyNumber
  let RefrenceNumberMayaForm = props?.location?.state?.data?.oonaPolicyResponse?.referenceNumber
  console.log("PolicyNumberMaya----", RefrenceNumberMayaForm);
  let PolicyIdFromMaya = props?.location?.state?.data?._id
  ...
  const policyPaymentFail = {
    ...
    section2: {
      title: `Policy #${PolicyNumberMaya ? PolicyNumberMaya : PolicyNumberMayaForm}`,
      subTitle: `Payment Reference #${RefrenceNumberMaya ? RefrenceNumberMaya : RefrenceNumberMayaForm}`,
      data: data,
      displayDetails: false,
      successBtn: {
        show: true,
  ...
  return (
    ...
    <Header />
      <div className="main-container">
        ...
        <QuoteSuccessPage {...policyPaymentFail} onClick={() => paymentFailed(PolicyId ? PolicyId : PolicyIdFromMaya)} />
