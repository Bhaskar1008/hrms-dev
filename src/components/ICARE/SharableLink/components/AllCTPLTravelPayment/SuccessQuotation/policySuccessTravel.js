  ...
  const Paymnetgatewayredirect = async (event) => {
    ...
    if (CTPLPolicy?.travelUserDetailedInfo === null) {
      ...
      //   policyNo: CTPLPolicy?.travelPolicyQuotationData?._id, // policy _id
        ...
        failureLink: Apiconfig?.ProjectLink + `/customer/travel-payment-return-url?Policy_Number=${CTPLPolicy?.travelPolicyQuotationData?.policyNumber}`,
        firstName: TravelDatafromlisting?.firstName,
        middleName: TravelDatafromlisting?.middleName,
        lastName: TravelDatafromlisting?.lastName,
        email: TravelDatafromlisting?.emailAddress,
        ...
        paymentText: event.paymentText,
        paymentLink: Apiconfig?.ProjectLink + '/customer/travel-cypher-payment/',
        successLink: Apiconfig?.ProjectLink + `/customer/travel-payment-return-url?Policy_Number=${CTPLPolicy?.travelPolicyQuotationData?.policyNumber}`,
        responseUrl: Apiconfig?.ProjectLink + "/customer/travel-payment-return-url", //return url
        currency: "PHP",
