...
export default function ConfirmPage() {
  ...
  const commercialStructure = GetAgentCodeFromJWT?.tokenData;
  console.log("commercialStructure", commercialStructure?.commercialStructureCode);
  ...
  const CommericalData = useSelector((state) => state);
  console.log("CommericalData", CommericalData);
  ...
  //     suffixName: quatationData?.CTPL_CustomerInfo_for_QuotationObj?.suffixName,
  ...
  let quotation_group_info = {
    commercial_structure : commercialStructure?.commercialStructureCode,
  };
  let createFormData = {
  ...
  const confrimPageData = async () => {
    ...
    setopenloader(true);
    let result = await axiosRequest.post("customer/ctpl-quotation", createFormData, { secure: true, });
