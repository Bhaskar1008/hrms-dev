...
import { setPolicyGeneratedInfo, setQuotationDetails } from "../../../../../../store/actions/travel";
...
export default function FormalQuoteInfo() {
  ...
  console.log("FGHtripInfo?.itenerary", tripData?.travelQuotationDetails?.travel_information?.travelData);
                ...
                <Row className="traveler" style={{ rowGap: "12px" }}>
                  ...
                  <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                    <div>
                      ...
                      <div className="subheading">
                        {tripData?.tripInfo?.itenerary ? tripData?.tripInfo?.itenerary : tripData?.travelQuotationDetails?.travel_information?.travelData?.itenerary}
                      </div>
                    </div>
                  </Col>
                  <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                    ...
                    <div>
                      ...
                      >
                        {tripData?.tripInfo?.hazardousSports == "false"
                          ? "No"
                          : tripData?.tripInfo?.hazardousSports ? tripData?.tripInfo?.hazardousSports : "-"}
                      </div>
                    </div>
                  </Col>
                  <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                    <div>
                      ...
                      >
                        {tripData?.tripInfo?.sportsEquipment == "false"
                          ? "No"
                          : tripData?.tripInfo?.sportsEquipment ? tripData?.tripInfo?.sportsEquipment : "-"}
                      </div>
                    </div>
                  </Col>
                </Row>
                  ...
                  >
                    ...
                    <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                      <div>
                        ...
                        <div className="subheading">{e.passportNumber ? e.passportNumber : "-"}</div>
                      </div>
                    </Col>
                    <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                      <div>
