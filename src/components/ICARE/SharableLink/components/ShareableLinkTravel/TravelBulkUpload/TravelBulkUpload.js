            ...
            <div className="right-sides">
              ...
              <div className="rsuploaderDiv">
                ...
                <div className="rsUploadText">
                  ...
                  <p style={{ color: '#000' }}><b>Download the Sample file <span style={{ color: "#1D428A" }}> <a href="https://image-upload-bucket-2019.s3.ap-south-1.amazonaws.com/Travel+Bulk+Upload.xlsx">
                    here
                  </a></span></b></p>
