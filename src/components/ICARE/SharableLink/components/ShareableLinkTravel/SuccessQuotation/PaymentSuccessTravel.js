...
export default function PaymentSuccessTravel() {
  ...
  let agentCodeSelect = tripData?.travelPolicyQuotationData?.agentCode
  console.log("tripData?.travelPolicyData?.agent",agentCodeSelect);
  ...
  const policyPaymentSuccess = {
    ...
    section2: {
      title: `Policy #${policyData ? policyData : ""}`,
