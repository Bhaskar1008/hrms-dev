    ...
    <>
      ...
      <div className="main-classinfo">
          ...
          >
            <div className="">
              ...
              <Row gutter={16}>
                {policyTypeList &&
                  ...
                  {channelCode.channelCode === "CH2" ? <>
                  <Col xs={24} sm={24} md={12} lg={24} xl={24}>
                  <div className="product1-or-text123">Send this link if your client wants to fill out the form</div>
                </Col>
                {/* <Col xs={24} sm={24} md={12} lg={24} xl={24}>
                  <div
              ...
              {/* {travelType === "Fleet" || travelType === "Bulk" ? (
              ""
            ) : (
              <>
                <Col
                ...
                >
                  ...
                  >
                    <Select
                      ...
                      //options={vehicelCategoryOptions}
                    ...
                    >
                      {vehicelCategoryApi?.length > 0
                        ? vehicelCategoryApi?.map((item, index) => (
            ...
            {/* <div className="next-button-headerinfo">
                  <Button
                    className="prev-buttoninfo"
                    size={size}
              ...
              <div className="btndiv">
                {/* <Button className="backbtn" onClick={onChangetoDashboard}>
                Back
              </Button> */}
                <Button
                  className="next"
