...
const VehicalInformation = () => {
  ...
  // console.log("hey1",login_user_data)
  ...
  //   vehicleStore?.subline ? vehicleStore?.subline : ""
  // );
  ...
  const [effectivityDate, setEffectivityDate] = useState(
    ""
    // moment(vehicleStore?.effectivityDate).format("MM/DD/YYYY") ? moment(vehicleStore?.effectivityDate).format("MM/DD/YYYY") : ""
    // vehicleStore?.effectivityDate ? vehicleStore?.effectivityDate : ""
  );
  console.log("hey-eff", effectivityDate);
  const [expiredDate, setExpiredDate] = useState(
    // moment(vehicleStore?.expiryDate).format("MM/DD/YYYY") ? moment(vehicleStore?.expiryDate).format("MM/DD/YYYY") : ""
    // vehicleStore?.expiryDate ? vehicleStore?.expiryDate : ""
    ""
  );
  ...
  // const [isNewCtplPolicy, setIsNewCtplPolicy] = useState(false);
  ...
  useEffect(() => {
    ...
    // setSubline(vehicleStore?.sublineName ? vehicleStore?.sublineName : "");
    setConductionNum(
    ...
    // setEffectivityDate(vehicleStore?.effectivityDate ? vehicleStore?.effectivityDate : "")
    // setExpiredDate(vehicleStore?.expiryDate ? moment(vehicleStore?.expiryDate).format("MM/DD/YYYY") : "")
  ...
  const VehicleValueChangeHandler = (value, key) => {
    ...
    console.log("VehicleValueChangeHandler", value);
  ...
  const getVehicleInfo = (formData) => {
    console.log("vehicalFormdata====>", formData);
              ...
              <div className="right-side">
                ...
                {/* <div className="first-info">
                  <h3 style={{ display: "-webkit-inline-box" }}>
                    I need to issue a &nbsp;
                    <Form.Item {...formItemLayout} className="form-item-name">
                      <Select
                        className="slect-methods laaaa"
                        placeholder="Select"
                  ...
                  <h3 style={{ display: "-webkit-inline-box" }}>
                    ...
                    >
                      <Select
                        className="slect-methods"
                        placeholder="Select"
                        onChange={PolicyOptionOnchange2}
                        value={policyTypeD2}
                        filterOption={(input, option) =>
                          option.props.children
                            .toLowerCase()
                      ...
                      <h3 style={{ display: "-webkit-inline-box" }}>
                        ...
                        >
                          <Select
                            ...
                            disabled
                          >
                            {PolicyTypeDataOption.map((item, index) => (
                              <Option key={index} value={item.value}>
                                {item.label}
                              </Option>
                            ))}
                  ...
                  <h3 style={{ display: "-webkit-inline-box" }}>
                    ...
                    >
                      <Select
                        style={{ width: "300px" }}
                        className="slect-methods2"
                        placeholder="Select"
                        onChange={PolicyOptionOnchangeVehical}
                        value={policyTypeDVehical}
                        filterOption={(input, option) =>
                          option.props.children
                            .toLowerCase()
                            .indexOf(input.toLowerCase()) >= 0
                        ...
                        disabled
                      >
                        {PolicyOptionVehical.map((item, index) => (
                          <Option key={index} value={item.value}>
                            {item.label}
                          </Option>
                        ))}
                  ...
                  <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                    ...
                    >
                      <Select
                        ...
                        // onSelect={(e, data) => modalSelectHandler(e, data)}
                        onChange={(item, key) => {
                ...
                <Row gutter={16}>
                  ...
                  <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                    <Form.Item
                      ...
                      rules={[
                        ...
                        // {
                        //   message: "Enter 3 Char and 4 Digit",
                        //   pattern: new RegExp(/^[A-Za-z]{3}\d{4}$/),
                        // },
                        {
                          max: 11,
                  ...
                  <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                    <Form.Item
                      ...
                      //   },
                      //   { max: 30, message: "Must be less than 30", min: 5 },
                      // ]}
                      rules={[
                        {
                          required: true,
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please select Vehicle Value",
                      },
                    ]}
                  >
                    <Select
                      ...
                      onChange={(item, key) => {
                        // setSelectedModelYear(key);
                        VehicleValueChangeHandler(item, key);
                      }}
                      options={VehicleValueOptions}
                      // value={vehicalModelYear}
                      filterOption={(input, option) =>
                        option.props.children
                          .toLowerCase()
                          .indexOf(input.toLowerCase()) >= 0
                    ...
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                      ...
                      >
                        ...
                        {/* <Input
                          ...
                          size="large"
                          value={effectivityDate}
                          // value={`${policyTerm?.month}/${policyTerm?.day}/${policyTerm?.effectiveYear}`}
                          // defaultValue={`${policyTerm?.month}/${policyTerm?.day}/${policyTerm?.effectiveYear}`}
                          placeholder="Select Date"
                          disabled
                    ...
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                      ...
                      >
                        ...
                        {/* <Input
                          ...
                          size="large"
                          value={expiredDate}
                          // value={`${policyTerm?.month}/${policyTerm?.day}/${policyTerm?.expiryYear}`}
                          placeholder="Select Date"
                ...
                <div className="next-button-header">
                  <Button
                    ...
                    htmlType="submit"
                    // onClick={onchangenextForfileValidation}
                  >
                    Next
                    <ArrowRightOutlined />
                  </Button>
